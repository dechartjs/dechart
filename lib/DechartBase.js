...
function () {
  function DechartBase(_ref) {
    ...
    _defineProperty(this, "$chartRoot", void 0);

    _defineProperty(this, "$htmlRoot", void 0);

    _defineProperty(this, "$svgRoot", void 0);
  ...
  _createClass(DechartBase, [{
    ...
    value: function globalStyle() {
      ...
      var ns = '.' + _dechart.DECHART_CLASS_NAME;
    ...
    value: function injectStyle() {
      document.getElementById(this.componentId).className += " ".concat(_dechart.DECHART_CLASS_NAME, " ").concat(this.chartType); // inject only once
    ...
    key: "beta__dispatch",
    value: function beta__dispatch(action) {
      /**
    ...
    key: "cssNamespace",
    get: function get() {
      return ".".concat(_dechart.DECHART_CLASS_NAME, ".").concat(this.chartType);
    }
  }, {
    key: "pureWidth",
    get: function get() {
    ...
    value: function requireNode(selector) {
      ...
      if (!node || node.empty()) {
        throw new Error("Dechart needs a html node: ".concat(selector));
      }
